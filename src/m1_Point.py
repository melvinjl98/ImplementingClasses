...
class Point(object):
    ...
    def move_by(self, dx, dy):
        """ Changes the point's x y location by the given dx dy"""
    ...
    def get_number_of_moves_made(self):
        """ Count the number of times the initial point moves"""
        return self.moves
    ...
    def get_distance_from_start(self):
        """ Find the distance the point travels froms its initial position"""
        distance = math.sqrt((self.initx - self.x)**2 + (self.inity - self.y)**2)
        return distance

    def get_distance_traveled(self):
        """ Takes all distances the point has traveled and sums them together"""
        return self.distance

    def closer_to(self, point2, point3):
        """ Determine which point is closer to the point and return that point"""
    ...
    def halfway_to(self, point2):
        """ Return a point that is the middle point of the given two points"""
        distance_x = (point2.x + self.x) / 2
        distance_y = (point2.y + self.y) / 2
